...
**1. Store the key as the `flight/resend` secret** (M1.3 needs this anyway). Paste to the Cowork agent — swap in your key and your **Resend-account email**:

ask """
>
Create the Resend secret in Secrets Manager, us-east-1:
>
